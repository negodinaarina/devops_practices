...
С помощью команды `kubectl ge all` модно получить нформацию о все подах, сервисах и деплоиментах в кластере, после применения всех конфигураций вывод получается такой:
